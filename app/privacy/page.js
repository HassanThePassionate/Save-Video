  ...
  return (
    <div>
      <div className='max-w-3xl mx-auto my-4 md:my-12 space-y-8'>
        <div>
          <div className='p-4 sm:px-10 md:pt-2'>
            <h1 className='scroll-m-20 text-4xl font-semibold tracking-tight pb-2'>
              Privacy Policy
            </h1>
            <p className=' pt-6 '>Last updated: August 09, 2023</p>
          </div>
          <div className='p-4 sm:px-10 pt-8 pb-10 flex gap-4 flex-col flex-wrap'>
            <div>
              <p>
            ...
            <div>
              <h2 className='text-4xl pb-10 pt-5 font-semibold'>
                Interpretation and Definitions
              </h2>
              <h4 className='text-2xl pb-8 pt-5 font-semibold'>
                Interpretation
              </h4>
              <p>
              ...
              <h4 className='text-2xl pb-2 pt-8 font-semibold'>Definitions</h4>
              <p className=' pb-5 '>For the purposes of this Privacy Policy:</p>
              <ul className=' marker:text-[#dadada] list-disc flex flex-col gap-8 pl-8'>
                <li>
            ...
            <div>
              <h2 className='text-4xl font-semibold pt-6 pb-4'>
                Collecting and Using Your <br /> Personal Data
              </h2>
              <h3 className='text-2xl font-semibold py-4'>
                Types of Data Collected
              </h3>
              <h4 className='text-xl font-semibold py-4'>Personal Data</h4>
              <p>
              ...
              <ul className=' marker:text-[#dadada] list-disc flex flex-col gap-6 pl-8 py-8'>
                <li>Email address</li>
                <li>First name and last name (Google Login)</li>
                <li>
                  Address, State, Province, ZIP/Postal code, City (Subscription
                  Invoices)
                </li>
                <li>Usage Data</li>
              </ul>
              <h4 className='text-lg font-semibold py-4'>Usage Data</h4>
              <p className=' pb-4'>
              ...
              <h4 className='text-2xl font-semibold py-6'>
              ...
              <ul className=' marker:text-[#dadada] list-disc flex flex-col gap-4 pl-8 py-4'>
                <li>Google</li>
                <li>Facebook</li>
                <li>Instagram</li>
                <li>Twitter</li>
              ...
              <ul className=' marker:text-[#dadada] list-disc flex flex-col gap-4 pl-8 py-6'>
                <li>
                ...
                <li>
                  <h6 className='text-lg font-semibold pb-4 pt-2'>
                    Necessary / Essential Cookies
                  </h6>
                  <p className=' pb-4 pt-2'>Type: Session Cookies</p>
                ...
                <li>
                  ...
                  <p className=' pb-4 pt-2'>Type: Session Cookies</p>
                  <p className=' pb-5 pt-2'>Administered by: Us</p>
                  <p>
              ...
              <h4 className='text-2xl font-semibold pb-4 pt-8'>
              ...
              <h2 className='text-4xl  font-semibold pb-8 pt-8'>
                Detailed Information on the <br /> Processing of Your Personal
                Data
              </h2>
              <p>
              ...
              <h3 className='text-lg  font-semibold pb-4 pt-6'>Payments</h3>
              <p>
              ...
              <ul className=' marker:text-[#dadada] list-disc flex flex-col gap-4 pl-8 pt-2 pb-4'>
                <li>
              ...
              <h3 className='text-2xl  font-semibold pb-6 pt-8'>
              ...
              <h2 className='text-4xl  font-semibold pb-6 pt-6'>
              ...
              <h2 className='text-4xl  font-semibold pb-6 pt-6'>Contact Us</h2>
              If you have any questions about this Privacy Policy, You can
              contact us:
              <ul className=' marker:text-[#dadada] list-disc flex flex-col gap-4 pl-8 pt-2 pb-4'>
                <li>
                  By email: <strong>info@writekit.ai</strong>
                </li>
              </ul>
            </div>
          </div>
